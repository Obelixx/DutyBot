...
namespace DutyBot.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<string>> PostAsync(CancellationToken cancellationToken = default)
        {
            ...
            return Ok($"Installations notifyed: {installations.Length}");
        }
    }
}
